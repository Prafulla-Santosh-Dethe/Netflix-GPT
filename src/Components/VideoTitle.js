...
const VideoTitle = ({title, overview}) => {
  ...
  return (
    ...
    <div className='w-screen h-[680px] pt-[15%] mx-10  absolute mt-5 bg-gradient-to-r from-black '>
        <h1 className='text-5xl font-bold p-1 text-white'>{title}</h1>
        <p className='py-6 px-1 text-lg w-2/6 text-white'>{overview}</p>
        <div className=''>
